...
import dataset.baidu_dataset as ds
...
def main():
    ...
    # Data loading code
    train_dataset = ds.LaneDataset(args, '/home/yuliangguo/Datasets/baidu/lane/all_data',
                                   'list/baidu/train.json', data_aug=True)
    train_loader = torch.utils.data.DataLoader(train_dataset, batch_size=args.batch_size,
                                               shuffle=True, num_workers=args.workers, pin_memory=False, drop_last=True)

    val_dataset = ds.LaneDataset(args, '/home/yuliangguo/Datasets/baidu/lane/all_data',
                                 'list/baidu/val.json', data_aug=False)
...
def save_checkpoint(state, is_best, filename='checkpoint.pth.tar'):
    if not os.path.exists('trained_baidu'):
        os.makedirs('trained_baidu')
    filename = os.path.join('trained_baidu', '_'.join((args.snapshot_pref, args.method.lower(), filename)))
    torch.save(state, filename)
    if is_best:
        best_name = os.path.join('trained_baidu',
